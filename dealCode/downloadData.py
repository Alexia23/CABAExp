...
def downloadfile(filepath,savedir):  
    ftp = ftpconnect('archive.routeviews.org')    
    #print ftp.getwelcome() #显示ftp服务器欢迎信息
    bufsize = 1024 #设置缓冲块大小      
    fp = open(savedir + filepath.split('/')[1] + '-' + filepath.split('/')[-1] ,'w'); #以写模式在本地打开文件
...
def getDownloadPath(date, time, savedir): #downloadfile("/route-views.eqix/bgpdata/2015.04/RIBS/rib.20150401.0000.bz2")  date:2015.04    time
    ...
    for dirName in ftp.nlst()[11:-7]:
        ...
        #print path
        downloadfile(path, savedir)

getDownloadPath('2015.04', '20150403.0000', '/home/wq/Work/simbgp/data/originData/')